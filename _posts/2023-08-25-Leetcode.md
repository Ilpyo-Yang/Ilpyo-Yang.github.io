...
+ [150. Evaluate Reverse Polish Notation](/job/2023/08/25/Leetcode.html#150-evaluate-reverse-polish-natation)
...
class Solution {
  public boolean isAnagram(String s, String t) {
    ...
    for(int i=0; i<t.length(); i++){
      char c = t.charAt(i);
      if(s_map.containsKey(c)!=t_map.containsKey(c)) return false;
