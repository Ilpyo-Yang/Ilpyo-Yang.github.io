...
![20230612_192728.png](/assets/gitbook/post_images/jpa/issue/20230612_192728.png)
...
**결과**  
아래처럼 config 작성시 ```jakarta.persistence.EntityManager```로도 ```JPAQueryFactory``` 빈 주입 및 생성에 문제가 없습니다.  
```java
